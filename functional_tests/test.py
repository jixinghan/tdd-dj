...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        self.browser.get(self.live_server_url)  # Here is why we use LiveServerTestCase
    ...
    def test_multiple_users_cat_start_lists_at_differet_urls(self):
        ...
        # Safisfied, they both go back to sleep
    ...
    def test_layout_and_styling(self):
        ...
        # She starts a new list and see that the input box is nicely
        # centered there too
